...
documento = "907.059.474-91"
protocolo = "1006460138"
razaoSocial = "SERGIO RICARDO GOUVEIA MARTINS"
valorNota = "125,00"
...
# while True:
#     try:
#         continua = browser.find_element(By.XPATH, '//*[@id="formMensagens:commandButton_confirmar"]').click()
#         break
#     except:
#         continue
